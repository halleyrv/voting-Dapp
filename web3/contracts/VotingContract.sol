...
contract VotingContract {
  ...
  address public voitingOrganizer;
  ...
  function setCandidate(
    ...
    require(voitingOrganizer == msg.sender, "Only Organizer can set candidate");
  ...
  function voterRight(
    ...
    require(voitingOrganizer == msg.sender, "Only Organizer can create voter");
